...
BREVO_DEFAULT_FROM_EMAIL = env("BREVO_DEFAULT_FROM_EMAIL", default="MS AMBAR <no-reply@ms-ambar.com>")
...
SES_DEFAULT_FROM_EMAIL = env("SES_DEFAULT_FROM_EMAIL", default="MS AMBAR <no-reply@ms-ambar.com>")
