...
export default function Suscribirse() {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white flex items-center justify-center px-6 py-20 relative overflow-hidden font-sans selection:bg-amber-honey/30">
      <Head>
      ...
      <AnimatePresence mode="wait">
        {!newsletterSuccess ? (
          ...
          <motion.div
            ...
            className="max-w-md w-full bg-white/[0.01] border border-white/5 p-8 md:p-12 rounded-[3.5rem] text-center backdrop-blur-xl amber-glass shadow-2xl relative z-10"
          >
            ...
            <p className="text-white/65 mb-10 text-xs leading-relaxed max-w-sm mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl font-serif text-white mb-4 tracking-tight italic font-normal">Frecuencia Sintonizada</h2>
            ...
            <Link
              href="/"
              className="w-full bg-white/5 hover:bg-white/10 active:scale-[0.98] border border-white/10 text-white font-black text-[10px] uppercase tracking-[0.25em] py-[18px] rounded-xl transition-all duration-300 whitespace-nowrap text-center block hover:scale-[1.02]"
            >
              Explorar MS AMBAR
            </Link>
          </motion.div>
