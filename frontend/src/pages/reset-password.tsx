    ...
    <div className="min-h-screen bg-[#030303] text-white flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-xs font-bold uppercase tracking-wider mt-1 text-center">
            ...
            {!success ? (
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="text-[10px] text-white/50 uppercase tracking-widest font-black block pl-1">Nueva Contraseña</label>
                ...
                <div className="space-y-2">
                  <label className="text-[10px] text-white/50 uppercase tracking-widest font-black block pl-1">Confirmar Nueva Contraseña</label>
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-white/30 group-focus-within:text-amber-500 transition-colors">
                      <Lock size={16} />
                    </div>
              ...
              >
                ...
                <h3 className="text-xl font-black uppercase italic tracking-tight">Contraseña Cambiada</h3>
                <p className="text-white/60 text-xs font-semibold leading-relaxed px-4">
                  Tu clave ha sido actualizada con éxito en la base de datos de MS AMBAR. Redirigiéndote al inicio de sesión...
                </p>
              </motion.div>
            )}
          </AnimatePresence>
        ...
        {(!uid || !token) && (
          <div className="text-center mt-6">
            <Link 
              ...
              className="inline-flex items-center gap-2 text-xs text-amber-500 hover:text-amber-400 font-black uppercase tracking-widest text-[9px] transition-colors"
            >
