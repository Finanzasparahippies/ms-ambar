...
parser.add_argument("--quality", type=int, default=50, help="JPEG/WebP quality (1-100, default 75)")
parser.add_argument("--max-size", type=int, default=720, help="Maximum width or height in pixels (default 1920)")
